...
define('TOKEN','5430451748:AAH5Enbn3YMXb-unGg5iJpSLKCNKG3wBuMM');

$message = mb_strtolower(($data['text'] ? $data['data'] : $data['data']),'utf-8');

// echo 'STI_Bot<br><br>';
// var_dump($data);
// https://api.telegram.org/bot5430451748:AAH5Enbn3YMXb-unGg5iJpSLKCNKG3wBuMM/sendMessage?chat_id=651492048&parse_mode=HTML&text=%3Ci%3E%D0%9F%D1%80%D0%B8%D0%B2%D0%B5%D1%82,%20%D0%94%D0%B8%D0%BC%D0%B0%3C/i%3E

function sendmsg($msg)
{
    $myCurl = curl_init();
    curl_setopt_array($myCurl, array(
        CURLOPT_URL => 'https://api.telegram.org/bot5430451748:AAH5Enbn3YMXb-unGg5iJpSLKCNKG3wBuMM/sendMessage?chat_id=651492048&parse_mode=HTML&text='. $msg,
